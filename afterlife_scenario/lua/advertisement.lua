...
if not wesnoth.have_file("~add-ons/afterlife_scenario") then
	...
	if wesnoth.compare_versions(remote_version, ">", local_version) then
		wesnoth.wml_actions.message {
			caption = "Afterlife",
			message = [[This game has NEWER Afterlife version than you have installed locally.

🠉🠉🠉 Please upgrade your Afterlife version. 🠉🠉🠉
